...
class RadioResponseModel {
  ...
  RadioResponseModel.fromJson(Map<String, dynamic> json) {
    if(json["radios"] is List) {
      radios = json["radios"] == null ? null : (json["radios"] as List).map((e) => Radios.fromJson(e)).toList();
    }
  }

  static List<RadioResponseModel> fromList(List<Map<String, dynamic>> list) {
    return list.map(RadioResponseModel.fromJson).toList();
  }
...
class Radios {
  ...
  static List<Radios> fromList(List<Map<String, dynamic>> list) {
    return list.map(Radios.fromJson).toList();
  }
